const routes = [
  {
    ...
    children: [
      ...
      {
        path: "educadores",
        component: () => import("pages/EducatorsPage.vue"),
      },
      { path: "busca", component: () => import("pages/SearchPage.vue") },
      {
        path: "perfilEducador/:id",
        name: "PerfilEducador",
        component: () => import("pages/PerfilEducador.vue"),
      },
      {
        path: "perfilCliente",
        component: () => import("pages/PerfilCliente.vue"),
      },
      {
        path: "ser-educador",
        component: () => import("pages/SerEducadorPage.vue"),
      },
      {
